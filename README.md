...
in unix systems: Linux, and MacOs, you need only to download either the binary files of SDL2 library, or compile, following this link [SDL2]("https://wiki.libsdl.org/SDL2/SourceCode")
